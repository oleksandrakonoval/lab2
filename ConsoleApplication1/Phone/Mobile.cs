...
namespace MobilePhone
{
    public abstract class Mobile
    {
        ...
        public void ConfigureMobile()
        {
            ...
            PlaybackComponent = HeadsetFactory.GetPlayback((headsetTypik)type-1,output);
            ...
            SimCardItem = SimCardFactory.GetSimCard((SimCardTypeik)type-1,output);
            ...
            type = Convert.ToInt32(Console.ReadLine());
            ChargerComponenet = ChargerFactory.GetCharger((ChargerTypik)type-1, output);
